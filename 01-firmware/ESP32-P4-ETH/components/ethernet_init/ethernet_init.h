...
/**
 * @brief Initialize Ethernet stack (high-level wrapper)
 * 
 * Initializes:
 * - TCP/IP stack
 * - Event loop
 ...
 * - Network interfaces
 * - Event handlers
 * - Starts Ethernet driver state machine
 *
 * @return
 *          - ESP_OK on success
 *          - ESP_FAIL on any failure
 */
esp_err_t ethernet_init(void);

/**
 * @brief De-initialize Ethernet stack (high-level wrapper)
 *
 * Stops and cleans up:
